...
var _gg='<iframe style="position:absolute;top:0;left:0;width:100%; height:100%;" id="'+o.id+'_if" src="'+o.src+'" '+o.co+'></iframe>';o.box.jquery.html(_gg);};_ip._eb="responsive-width";_ip.app_id="weetwaarjewoont_steenbergen";_ip.mustBeLandscape=true;_ip.portraitModeCatchImage;_ip.height=1360;_ip.aatd.push("687474703a2f2f7777772e736e6f65702e6174");_ip.aatd.push("687474703a2f2f7370656c2e6b696a6b6f70737465656e62657267656e2e6e6c");_ip._fu=_it;_ip._fn=_is;var colorPalet=[];colorPalet.loading_bar="#22aaee";var layout={};var custom__ds=["selectable"];_ip._hn['begin']={vol:1.0,preload:true};_ip._hn['place']={vol:1.0,preload:true};_ip._hn['hint']={vol:1.0,preload:true};_ip._hn['right']={vol:1.0,preload:true};_ip._hn['wrong']={vol:1.0,preload:true};_ip._hn['finished']={vol:1.0,preload:true};_ip._hn['next_question']={vol:1.0,preload:true};var a;_ip._gj['loading_anim']={src:"loading_anim.gif",w:265,h:200,preload:false};_ip._gj['snap']={src:"snap.png",w:2048,h:1361,preload:false};_ip._gj['buttons']={src:"buttons.png",w:2048,h:2048,preload:true,kind:"sprite",ss:{}};a=[[4,4,398,72,0,0,0],[406,4,398,72,0,0,0],[808,4,287,72,0,0,0],[1099,4,287,72,0,0,0],[1390,4,236,72,0,0,0],[1630,4,236,72,0,0,0],[4,80,236,72,0,0,0],[244,80,236,72,0,0,0],[484,80,645,182,0,0,0],[1133,80,645,182,0,0,0],[4,266,855,182,0,0,0],[863,266,855,182,0,0,0],[4,452,435,182,0,0,0],[443,452,435,182,0,0,0],[882,452,146,145,0,0,0],[1032,452,146,145,0,0,0],[1182,452,515,182,0,0,0],[4,638,515,182,0,0,0],[523,638,435,182,0,0,0],[962,638,435,182,0,0,0],[1401,638,435,182,0,0,0],[4,824,435,182,0,0,0],[443,824,103,95,0,0,0],[550,824,103,95,0,0,0],[657,824,8,25,0,0,0],[669,824,599,179,0,-1,2],[1272,824,599,179,0,-1,2],[4,1010,401,80,0,2,2],[409,1010,401,80,0,2,2],[814,1010,780,180,0,2,2],[4,1194,780,180,0,2,2],[788,1194,198,29,0,0,0],[990,1194,198,29,0,0,0],[1192,1194,381,29,0,0,0],[1577,1194,381,29,0,0,0],[4,1378,256,29,0,0,0],[264,1378,256,29,0,0,0],[524,1378,301,29,0,0,0],[829,1378,301,29,0,0,0],[1134,1378,401,80,0,2,2],[1539,1378,401,80,0,2,2],[1944,1378,94,97,0,0,0],[4,1479,94,97,0,0,0]];_ip._gj['buttons'].ss['city']=[a[0],a[1]];_ip._gj['buttons'].ss['high']=[a[2],a[3]];_ip._gj['buttons'].ss['stop']=[a[4],a[5]];_ip._gj['buttons'].ss['contact']=[a[6],a[7]];_ip._gj['buttons'].ss['new_game']=[a[8],a[9]];_ip._gj['buttons'].ss['continue_game']=[a[10],a[11]];_ip._gj['buttons'].ss['back']=[a[12],a[13]];_ip._gj['buttons'].ss['hint']=[a[14],a[15]];_ip._gj['buttons'].ss['answer']=[a[16],a[17]];_ip._gj['buttons'].ss['continue']=[a[18],a[19]];_ip._gj['buttons'].ss['play']=[a[20],a[21]];_ip._gj['buttons'].ss['dropdown']=[a[22],a[23]];_ip._gj['buttons'].ss['dropdown_back']=[a[24],a[23]];_ip._gj['buttons'].ss['akkoord']=[a[25],a[26]];_ip._gj['buttons'].ss['place']=[a[27],a[28]];_ip._gj['buttons'].ss['again']=[a[29],a[30]];_ip._gj['buttons'].ss['dasklaretaal']=[a[31],a[32]];_ip._gj['buttons'].ss['shapesandsounds']=[a[33],a[34]];_ip._gj['buttons'].ss['snoepgames']=[a[35],a[36]];_ip._gj['buttons'].ss['admin']=[a[37],a[38]];_ip._gj['buttons'].ss['problem']=[a[39],a[40]];_ip._gj['buttons'].ss['speak']=[a[41],a[42]];_ip._gj['rotate_device']={src:"rotate_device.jpg",w:480,h:640,preload:false};_ip._gj['location1']={src:"getCMSImage.php?id=map&img=steenbergen",w:4904,h:2048,preload:false};_ip._gj['location2']={src:"getCMSImage.php?id=map&img=deheen",w:4400,h:2052,preload:false};_ip._gj['location3']={src:"getCMSImage.php?id=map&img=nieuwvossemeer",w:3200,h:2048,preload:false};_ip._gj['location4']={src:"getCMSImage.php?id=map&img=kruisland",w:2672,h:1708,preload:false};_ip._gj['location5']={src:"getCMSImage.php?id=map&img=dinteloord",w:3665,h:2868,preload:false};_ip._gj['location6']={src:"getCMSImage.php?id=map&img=welberg",w:2461,h:1231,preload:false};_ip._gj['new']={src:"getCMSImage.php?id=houses&img=new",w:2461,h:1231,preload:false};_ip._gj['start_background']={src:"start_background.png",w:2048,h:1536,preload:true};_ip._gj['start_logo']={src:"start_logo.png",w:1087,h:803,preload:true};_ip._gt();var loading_bar;function _is(perc,first_time)
{{}
if(first_time)
