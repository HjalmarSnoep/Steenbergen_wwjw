...
_ip._ds.sound=true;_ip._ds.music=true;_ip.audio_preloaded=0;_ip._fh=0;_ip.voice_dom=document.createElement("audio");function _ak(value)
{if(value==false)
...
{{}}}}}else
{{}}}
_ip.stopVoice=_iqStopVoice;function _iqStopVoice()
{{}
_ip.voice_dom.pause();}
_ip.playVoice=_iqPlayVoice;function _iqPlayVoice(file)
{document.body.appendChild(_ip.voice_dom);{}
_ip.voice_dom.src="voice/"+file;_ip.voice_dom.play();}
...
{{}
return;}
image=_ip._gj[img_nr].img;bw=_ip._gj[img_nr].w;bh=_ip._gj[img_nr].h;hbc.context.save();hbc.context.translate(x,y);hbc.context.scale(s,s);hbc.context.rotate(r*_ip.TO_RADIANS);bw=Math.floor(bw);bh=Math.floor(bh);bh=Math.floor(bh);hbc.context.drawImage(image,0,0,bw,bh,-bw/2,-bh/2,bw,bh);hbc.context.restore();}
...
var _gg='<iframe style="position:absolute;top:0;left:0;width:100%; height:100%;" id="'+o.id+'_if" src="'+o.src+'" '+o.co+'></iframe>';o.box.jquery.html(_gg);};_ip._eb="responsive-width";_ip.app_id="weetwaarjewoont_steenbergen";_ip.mustBeLandscape=true;_ip.portraitModeCatchImage;_ip.height=1360;_ip.aatd.push("687474703a2f2f7777772e736e6f65702e6174");_ip.aatd.push("687474703a2f2f7370656c2e6b696a6b6f70737465656e62657267656e2e6e6c");_ip._fu=_it;_ip._fn=_is;var colorPalet=[];colorPalet.loading_bar="#22aaee";var layout={};var custom__ds=["selectable"];_ip._hn['begin']={vol:1.0,preload:true};_ip._hn['place']={vol:1.0,preload:true};_ip._hn['hint']={vol:1.0,preload:true};_ip._hn['right']={vol:1.0,preload:true};_ip._hn['wrong']={vol:1.0,preload:true};_ip._hn['finished']={vol:1.0,preload:true};_ip._hn['next_question']={vol:1.0,preload:true};var a;_ip._gj['loading_anim']={src:"loading_anim.gif",w:265,h:200,preload:false};_ip._gj['snap']={src:"snap.png",w:2048,h:1361,preload:false};_ip._gj['buttons']={src:"buttons.png",w:2048,h:2048,preload:true,kind:"sprite",ss:{}};a=[[4,4,398,72,0,0,0],[406,4,398,72,0,0,0],[808,4,287,72,0,0,0],[1099,4,287,72,0,0,0],[1390,4,236,72,0,0,0],[1630,4,236,72,0,0,0],[4,80,236,72,0,0,0],[244,80,236,72,0,0,0],[484,80,645,182,0,0,0],[1133,80,645,182,0,0,0],[4,266,855,182,0,0,0],[863,266,855,182,0,0,0],[4,452,435,182,0,0,0],[443,452,435,182,0,0,0],[882,452,146,145,0,0,0],[1032,452,146,145,0,0,0],[1182,452,515,182,0,0,0],[4,638,515,182,0,0,0],[523,638,435,182,0,0,0],[962,638,435,182,0,0,0],[1401,638,435,182,0,0,0],[4,824,435,182,0,0,0],[443,824,103,95,0,0,0],[550,824,103,95,0,0,0],[657,824,8,25,0,0,0],[669,824,599,179,0,-1,2],[1272,824,599,179,0,-1,2],[4,1010,401,80,0,2,2],[409,1010,401,80,0,2,2],[814,1010,780,180,0,2,2],[4,1194,780,180,0,2,2],[788,1194,198,29,0,0,0],[990,1194,198,29,0,0,0],[1192,1194,381,29,0,0,0],[1577,1194,381,29,0,0,0],[4,1378,256,29,0,0,0],[264,1378,256,29,0,0,0],[524,1378,301,29,0,0,0],[829,1378,301,29,0,0,0],[1134,1378,401,80,0,2,2],[1539,1378,401,80,0,2,2],[1944,1378,94,97,0,0,0],[4,1479,94,97,0,0,0],[4,156,72,72,0,0,0],[79,156,72,72,0,0,0],[155,156,72,72,0,0,0],[231,156,72,72,0,0,0]];_ip._gj['buttons'].ss['city']=[a[0],a[1]];_ip._gj['buttons'].ss['high']=[a[2],a[3]];_ip._gj['buttons'].ss['stop']=[a[4],a[5]];_ip._gj['buttons'].ss['contact']=[a[6],a[7]];_ip._gj['buttons'].ss['new_game']=[a[8],a[9]];_ip._gj['buttons'].ss['continue_game']=[a[10],a[11]];_ip._gj['buttons'].ss['back']=[a[12],a[13]];_ip._gj['buttons'].ss['hint']=[a[14],a[15]];_ip._gj['buttons'].ss['answer']=[a[16],a[17]];_ip._gj['buttons'].ss['continue']=[a[18],a[19]];_ip._gj['buttons'].ss['play']=[a[20],a[21]];_ip._gj['buttons'].ss['dropdown']=[a[22],a[23]];_ip._gj['buttons'].ss['dropdown_back']=[a[24],a[23]];_ip._gj['buttons'].ss['akkoord']=[a[25],a[26]];_ip._gj['buttons'].ss['place']=[a[27],a[28]];_ip._gj['buttons'].ss['again']=[a[29],a[30]];_ip._gj['buttons'].ss['dasklaretaal']=[a[31],a[32]];_ip._gj['buttons'].ss['shapesandsounds']=[a[33],a[34]];_ip._gj['buttons'].ss['snoepgames']=[a[35],a[36]];_ip._gj['buttons'].ss['admin']=[a[37],a[38]];_ip._gj['buttons'].ss['problem']=[a[39],a[40]];_ip._gj['buttons'].ss['speak']=[a[41],a[42]];_ip._gj['buttons'].ss['prev']=[a[43],a[44]];_ip._gj['buttons'].ss['next']=[a[45],a[46]];_ip._gj['rotate_device']={src:"rotate_device.jpg",w:480,h:640,preload:false};_ip._gj['location1']={src:"getCMSImage.php?id=map&img=steenbergen",w:4904,h:2048,preload:false};_ip._gj['location2']={src:"getCMSImage.php?id=map&img=deheen",w:4400,h:2052,preload:false};_ip._gj['location3']={src:"getCMSImage.php?id=map&img=nieuwvossemeer",w:3200,h:2048,preload:false};_ip._gj['location4']={src:"getCMSImage.php?id=map&img=kruisland",w:2672,h:1708,preload:false};_ip._gj['location5']={src:"getCMSImage.php?id=map&img=dinteloord",w:3665,h:2868,preload:false};_ip._gj['location6']={src:"getCMSImage.php?id=map&img=welberg",w:2461,h:1231,preload:false};_ip._gj['new']={src:"getCMSImage.php?id=houses&img=new",w:2461,h:1231,preload:false};_ip._gj['start_background']={src:"start_background.png",w:2048,h:1536,preload:true};_ip._gj['start_logo']={src:"start_logo.png",w:1087,h:803,preload:true};_ip._gt();var loading_bar;function _is(perc,first_time)
{{}
if(first_time)
...
{{}
quiz.questions=response.questions;user.data=response.user;quiz.nr_of_questions=quiz.questions.length;quiz.question_order=response.user.question_order;for(var i=0;i<quiz.question_order.length;i++)
...
var new_game={};new_game.init=_jh;new_game.framecounter=0;new_game.buttons_Alpha=0;new_game.state="just_started";new_game.form={naam:"",wachtwoord:"",school:-1,groep:-1,plaats:-1,category:-1};new_game.cms_data={};new_game.cms_data.school=[{label:"De Nieuwe Veste",id:"sdif4356srhe"},{label:"Maria Regina",id:"sdiofhoe"},{label:"Gummarusschool",id:"sd56pfioei"},{label:"Merijntje",id:"idfhrs"},{label:"Regenboog, De",id:"sd83ls"},{label:"De zonneberg",id:"dfoihsue"},{label:"Petrus en Paulusschool",id:"78sd3ogosd"},{label:"Groen van Prinsterer",id:"98sdyvj"},{label:"Pius X",id:"fgf45uh"},{label:"niet van toepassing",id:"666"}];new_game.cms_data.groep=[{label:"Groep 1",id:1},{label:"Groep 2",id:2},{label:"Groep 3",id:3},{label:"Groep 4",id:4},{label:"Groep 5",id:5},{label:"Groep 6",id:6},{label:"Groep 7",id:7},{label:"Groep 8",id:8},{label:"niet van toepassing",id:"666"}];new_game.cms_data.category=cms.tags;console.log("CMS.tags="+JSON.stringify(cms.tags));for(var i=new_game.cms_data.category.length-1;i>=0;i--)
{console.log("new_game.cms_data.category["+i+"]="+JSON.stringify(new_game.cms_data.category[i]));if(typeof(new_game.cms_data.category[i].questions)=="undefined")
{new_game.cms_data.category.splice(i,1);}else{if(new_game.cms_data.category[i].questions<30)
{new_game.cms_data.category.splice(i,1);}else{new_game.cms_data.category[i].label+=" (30/"+new_game.cms_data.category[i].questions+" vragen)";}}}
new_game.cms_data.category.push({label:"Alles",id:-1});new_game.cms_data.plaats=[{label:"Steenbergen",id:1},{label:"De Heen",id:2},{label:"Nieuw Vossemeer",id:3},{label:"Kruisland",id:4},{label:"Dinteloord",id:5},{label:"Welberg",id:6}];function _jh()
...
_ip._em("lastpage","new_game");new_game.form.naam="";new_game.form.school=-1;new_game.form.groep=-1;new_game.form.plaats=-1;new_game.form.category=-1;if(_ip._gn("user_naam")!==null)new_game.form.naam=_ip._gn("user_naam");if(_ip._gn("user_school")!==null)new_game.form.school=_ip._gn("user_school");if(_ip._gn("user_groep")!==null)new_game.form.groep=_ip._gn("user_groep");if(_ip._gn("user_plaats")!==null)new_game.form.plaats=_ip._gn("user_plaats");_ip.resizeFunction=new_gameHandleResize;new_gameHandleResize();_ji();}}
function _ji()
{var on_page=true;if(typeof(layout.naam_text)!="undefined"&&typeof(layout.wachtwoord_text)!="undefined")
{new_game.form.naam=_ip.getText(layout.naam_text);new_game.form.wachtwoord=_ip.getText(layout.wachtwoord_text);}else{on_page=false;}
if(on_page)
window.requestAnimationFrame(_ji);}
...
w=_ip._gj['buttons'].ss['dropdown'][0][2];h=_ip._gj['buttons'].ss['dropdown'][0][3];x=_ip.width-w;_ip._hd(layout.buttons,x,y,w,h,'buttons',"dropdown","button_dropdown_plaats",new_gameHandleButtons);w=layout.split_w+10;h=94;x=layout.split_x;y=345+5*layout.button_margin_y;layout.category=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.category,palet.pale_green);_ip.setBevel(layout.category,5,"rgba(10,23,53,0.5)","rgba(255,255,255,0.5)");layout.category_text=_ip._hc(layout.category,40,10,w-80,h-20,fonts.head,palet.dark_blue,"left",fontsz.edit,"- Onderwerpen -");_ip._fk(layout.category_text,"button_dropdown_category",new_gameHandleButtons);if(new_game.form.category!=-1)
{{}
var label=_jk("category",new_game.form.category);_ip.setText(layout.category_text,label);}
w=_ip._gj['buttons'].ss['dropdown'][0][2];h=_ip._gj['buttons'].ss['dropdown'][0][3];x=_ip.width-w;_ip._hd(layout.buttons,x,y,w,h,'buttons',"dropdown","button_dropdown_category",new_gameHandleButtons);x=layout.split_x;y=345+6*layout.button_margin_y;w=layout.split_w+10;h=90;layout.feedback_text=_ip._hc(layout.buttons,x,y,w,h,"sans-serif",palet.dark_red,"center",30,"");_ip._es(layout.feedback_text,palet.pale_green);_ip._eg(layout.feedback_text,false);}
...
break;case"category":_ip.setText(layout.category_text,label);new_game.form.category=id;{}
break;}
_ip._fa(layout.popup);_ip._ey();}else
{}}}
function _jn()
...
{var data={};data.naam=new_game.form.naam;data.wachtwoord=new_game.form.wachtwoord;data.school=new_game.form.school;data.groep=new_game.form.groep;data.plaats=new_game.form.plaats;data.category=new_game.form.category;_ip.getVars("new_game.php",data,_jo,_jp)}else
...
{var data={};data.succes=0;data.stat="new_game";_ip.setVars("add_stat.php",data);_ip.setText(layout.feedback_text,"Server bezet, probeer later");_ip._eg(layout.feedback_text,true);_ip._fd("wrong");{}}
function new_gameHandleButtons(label)
{switch(label)
{case"button_continue_new_game":_jn();break;case"button_dropdown_school":_jl("school");break;case"button_dropdown_groep":_jl("groep");break;case"button_dropdown_plaats":_jl("plaats");break;case"button_dropdown_category":_jl("category");break;case"button_close_popup":_ip._fa(layout.popup);_ip._ey();break;default:{}}}
var resume_game={};resume_game.init=_jr;resume_game.form={naam:"",wachtwoord:""};function _jr()
{if(_ip._gn("wwjw_disclaimer")!="1")
{{}
...
function _js()
{var on_page=true;if(typeof(layout.naam_text)!="undefined"&&typeof(layout.wachtwoord_text)!="undefined")
{resume_game.form.naam=_ip.getText(layout.naam_text);resume_game.form.wachtwoord=_ip.getText(layout.wachtwoord_text);}else{on_page=false;}
if(on_page)
window.requestAnimationFrame(_js);}
...
{console.log("setting naam on resize");_ip.setText(layout.naam_text,resume_game.form.naam);_ip.setTextBoxColor(layout.naam_text,palet.dark_blue);}
w=layout.split_w+10;h=94;x=layout.split_x;y=345+1*layout.button_margin_y;layout.wachtwoord=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.wachtwoord,palet.pale_green);_ip.setBevel(layout.wachtwoord,5,"rgba(10,23,53,0.5)","rgba(255,255,255,0.5)");layout.wachtwoord_text=_ip.createTextInput(layout.wachtwoord,40,10,w-80,h-20,fonts.head,palet.pale_grey,"left",fontsz.edit,"wachtwoord","password");if(resume_game.form.wachtwoord!="")
{console.log("setting wachtewoord");_ip.setText(layout.wachtwoord_text,resume_game.form.wachtwoord);_ip.setTextBoxColor(layout.wachtwoord_text,palet.dark_blue);}
x=layout.split_x;y=900;w=layout.split_w+10;h=300;layout.feedback_text=_ip._hc(layout.buttons,x,y,w,h,fonts.head,palet.dark_red,"center",fontsz.edit,"");_ip._es(layout.feedback_text,palet.pale_green);_ip._eg(layout.feedback_text,false);}
function _ju()
...
var reset_game={};reset_game.init=initreset_game;reset_game.framecounter=0;reset_game.state="just_started";reset_game.form={};reset_game.cms_data={};reset_game.cms_data.school=[{label:"De Nieuwe Veste",id:"sdif4356srhe"},{label:"Maria Regina",id:"sdiofhoe"},{label:"Gummarusschool",id:"sd56pfioei"},{label:"Merijntje",id:"idfhrs"},{label:"Regenboog, De",id:"sd83ls"},{label:"De zonneberg",id:"dfoihsue"},{label:"Petrus en Paulusschool",id:"78sd3ogosd"},{label:"Groen van Prinsterer",id:"98sdyvj"},{label:"Pius X",id:"fgf45uh"},{label:"niet van toepassing",id:"666"}];reset_game.cms_data.groep=[{label:"Groep 1",id:1},{label:"Groep 2",id:2},{label:"Groep 3",id:3},{label:"Groep 4",id:4},{label:"Groep 5",id:5},{label:"Groep 6",id:6},{label:"Groep 7",id:7},{label:"Groep 8",id:8},{label:"niet van toepassing",id:"666"}];reset_game.cms_data.category=cms.tags;for(var i=reset_game.cms_data.category.length-1;i>=0;i--)
{if(typeof(reset_game.cms_data.category[i].questions)=="undefined")
{reset_game.cms_data.category.splice(i,1);}else{if(reset_game.cms_data.category[i].questions<30)
{reset_game.cms_data.category.splice(i,1);}else{reset_game.cms_data.category[i].label=reset_game.cms_data.category[i].label.split(" (")[0];reset_game.cms_data.category[i].label+=" (30/"+reset_game.cms_data.category[i].questions+" vragen)";}}}
reset_game.cms_data.category.push({label:"Alles",id:-1});reset_game.cms_data.plaats=[{label:"Steenbergen",id:1},{label:"De Heen",id:2},{label:"Nieuw Vossemeer",id:3},{label:"Kruisland",id:4},{label:"Dinteloord",id:5},{label:"Welberg",id:6}];function initreset_game()
{{}
{}
if(_ip._gn("wwjw_disclaimer")!="1")
{{}
user.refer_to="new";disclaimer.init();}else
{var data={};data.page="reset_game";data.stat="page";_ip.setVars("add_stat.php",data);_ip._fd("next_question");{}
_ip._em("lastpage","reset_game");reset_game.form.school=user.data.school;reset_game.form.groep=user.data.groep;reset_game.form.plaats=user.data.plaats;reset_game.form.category=user.data.category;_ip.resizeFunction=reset_gameHandleResize;reset_gameHandleResize();}}
...
{{}
_ip._gp();layout={};_iw();layout.buttons=_ip._he();var w,h,x,y,f,tx,ty,string;w=900;h=1020;x=100;y=345;layout.wit_vlak=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.wit_vlak,palet.pale_green);_ip._et(layout.wit_vlak,0.80);x=100;y=779/2;w=w-200;h=700;string="";string+="<h1>Weet waar je woont!</h1>";string+="Hier kun je kiezen een andere categorie te spelen. Kun je niet beslissen? Dan kies je toch gewoon 'alles'!<br><br>Ook kun je eventueel je plaats, school of groep wijzigen. Voor als je over gaat of verhuisd.";_ip._hc(layout.wit_vlak,x,y,w,h,"sans-serif","#2f2f2f","left",30,string);layout.split_x=1040;layout.split_w=_ip.width-layout.split_x;layout.button_margin_y=114;w=_ip._gj['buttons'].ss['continue'][0][2];h=_ip._gj['buttons'].ss['continue'][0][3];x=layout.split_x+layout.split_w/2-w/2;y=_ip.height-h-60;_ip._hd(layout.buttons,x,y,w,h,'buttons',"continue","button_continue_reset_game",reset_gameHandleButtons);x=148;y=78;w=810;h=617;layout.logo=_ip._hi(layout.buttons,x,y,w,h);_ip._er(layout.logo,"start_logo");_ip._et(layout.logo,0.85);w=layout.split_w+10;h=94;x=layout.split_x;y=345;layout.naam=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.naam,palet.pale_green);layout.naam_text=_ip._hc(layout.naam,40,10,w-80,h-20,fonts.head,palet.dark_blue,"left",fontsz.edit-3,"naam: "+user.data.naam);_ip._es(layout.naam_text,palet.pale_green);w=layout.split_w+10;h=94;x=layout.split_x;y=345+1*layout.button_margin_y;layout.wachtwoord=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.wachtwoord,palet.pale_green);_ip.setBevel(layout.wachtwoord,5,"rgba(10,23,53,0.5)","rgba(255,255,255,0.5)");layout.wachtwoord_text=_ip.createTextInput(layout.wachtwoord,40,10,w-80,h-20,fonts.head,palet.pale_grey,"left",fontsz.edit,"wachtwoord");w=layout.split_w+10;h=94;x=layout.split_x;y=345+2*layout.button_margin_y;layout.school=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.school,palet.pale_green);_ip.setBevel(layout.school,5,"rgba(10,23,53,0.5)","rgba(255,255,255,0.5)");layout.school_text=_ip._hc(layout.school,40,10,w-80,h-20,fonts.head,palet.dark_blue,"left",fontsz.edit,"- school -");_ip._fk(layout.school_text,"button_dropdown_school",reset_gameHandleButtons);if(reset_game.form.school!=-1)
{{}
var label=reset_game_GetLabelFromId("school",reset_game.form.school);_ip.setText(layout.school_text,label);}
w=_ip._gj['buttons'].ss['dropdown'][0][2];h=_ip._gj['buttons'].ss['dropdown'][0][3];x=_ip.width-w;_ip._hd(layout.buttons,x,y,w,h,'buttons',"dropdown","button_dropdown_school",reset_gameHandleButtons);w=layout.split_w+10;h=94;x=layout.split_x;y=345+3*layout.button_margin_y;layout.groep=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.groep,palet.pale_green);_ip.setBevel(layout.groep,5,"rgba(10,23,53,0.5)","rgba(255,255,255,0.5)");layout.groep_text=_ip._hc(layout.groep,40,10,w-80,h-20,fonts.head,palet.dark_blue,"left",fontsz.edit,"- groep -");_ip._fk(layout.groep_text,"button_dropdown_groep",reset_gameHandleButtons);if(reset_game.form.groep!=-1)
{{}
var label=reset_game_GetLabelFromId("groep",reset_game.form.groep);_ip.setText(layout.groep_text,label);}
w=_ip._gj['buttons'].ss['dropdown'][0][2];h=_ip._gj['buttons'].ss['dropdown'][0][3];x=_ip.width-w;_ip._hd(layout.buttons,x,y,w,h,'buttons',"dropdown","button_dropdown_groep",reset_gameHandleButtons);w=layout.split_w+10;h=94;x=layout.split_x;y=345+4*layout.button_margin_y;layout.plaats=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.plaats,palet.pale_green);_ip.setBevel(layout.plaats,5,"rgba(10,23,53,0.5)","rgba(255,255,255,0.5)");layout.plaats_text=_ip._hc(layout.plaats,40,10,w-80,h-20,fonts.head,palet.dark_blue,"left",fontsz.edit,"- plaats -");_ip._fk(layout.plaats_text,"button_dropdown_plaats",reset_gameHandleButtons);if(reset_game.form.plaats!=-1)
{{}
var label=reset_game_GetLabelFromId("plaats",reset_game.form.plaats);_ip.setText(layout.plaats_text,label);}
w=_ip._gj['buttons'].ss['dropdown'][0][2];h=_ip._gj['buttons'].ss['dropdown'][0][3];x=_ip.width-w;_ip._hd(layout.buttons,x,y,w,h,'buttons',"dropdown","button_dropdown_plaats",reset_gameHandleButtons);w=layout.split_w+10;h=94;x=layout.split_x;y=345+5*layout.button_margin_y;layout.category=_ip._hi(layout.buttons,x,y,w,h);_ip._es(layout.category,palet.pale_green);_ip.setBevel(layout.category,5,"rgba(10,23,53,0.5)","rgba(255,255,255,0.5)");layout.category_text=_ip._hc(layout.category,40,10,w-80,h-20,fonts.head,palet.dark_blue,"left",fontsz.edit,"- Onderwerpen -");_ip._fk(layout.category_text,"button_dropdown_category",reset_gameHandleButtons);if(reset_game.form.category!=-1)
{{}
var label=reset_game_GetLabelFromId("category",reset_game.form.category);_ip.setText(layout.category_text,label);}
w=_ip._gj['buttons'].ss['dropdown'][0][2];h=_ip._gj['buttons'].ss['dropdown'][0][3];x=_ip.width-w;_ip._hd(layout.buttons,x,y,w,h,'buttons',"dropdown","button_dropdown_category",reset_gameHandleButtons);x=layout.split_x;y=345+6*layout.button_margin_y;w=layout.split_w+10;h=90;layout.feedback_text=_ip._hc(layout.buttons,x,y,w,h,"sans-serif",palet.dark_red,"center",30,"");_ip._es(layout.feedback_text,palet.pale_green);_ip._eg(layout.feedback_text,false);_ip.textChangeListener=reset_game_TextChangeListener;}
function reset_game_GetLabelFromId(datagroep,id)
{var i;var label="---";for(i=0;i<reset_game.cms_data[datagroep].length;i++)
...
{_ip._ex();var dataprovider=reset_game.cms_data[label];{}
layout.popup=_ip._he();_ip._es(layout.popup,palet.pale_grey);var w=_ip._gj['buttons'].ss['dropdown'][0][2];var h=_ip._gj['buttons'].ss['dropdown'][0][3];var x=_ip.width-w;var y=0;layout.viewport_y=h;layout.viewport_h=_ip.height-layout.viewport_y;layout.popup_title=_ip._hi(layout.popup,0,0,_ip.width,h);_ip._es(layout.popup_title,palet.dark_blue);w=_ip._gj['buttons'].ss['dropdown'][0][2];h=_ip._gj['buttons'].ss['dropdown'][0][3];x=_ip.width-w;y=0;_ip._hd(layout.popup_title,x,y,w,h,'buttons',"dropdown","button_close_popup",reset_gameHandleButtons_popup);layout.popup_scroll=_ip._hi(layout.popup,0,layout.viewport_y,_ip.width,layout.viewport_h);_ip._es(layout.popup_scroll,palet.pale_grey);var i,margin=150,rows=1,w=_ip.width,row_len=9;if(dataprovider.length<row_len)
{margin=layout.viewport_h/dataprovider.length;}else
{margin=layout.viewport_h/row_len;if(Math.floor(dataprovider.length/row_len)==(dataprovider.length/row_len))
{rows=Math.floor(dataprovider.length/row_len);}else
{rows=Math.floor(dataprovider.length/row_len)+1;}
w=_ip.width/rows;{}}
for(i=0;i<dataprovider.length;i++)
{var x=Math.floor(i/row_len)*w;var y=(i%row_len)*margin;_ip._hb(layout.popup_scroll,x,y,w,margin,dataprovider[i].label,"list_"+label+"_"+dataprovider[i].id,reset_gameHandleButtons_popup,50);}}
...
{{}
var parts=label.split("_");var field=parts[1];var id=parts[2];{}
var i;for(i=0;i<reset_game.cms_data[field].length;i++)
{if(reset_game.cms_data[field][i].id==id)
{label=reset_game.cms_data[field][i].label;}}
{}
{}
switch(field)
{case"school":_ip.setText(layout.school_text,label);reset_game.form.school=id;{}
break;case"groep":_ip.setText(layout.groep_text,label);reset_game.form.groep=id;{}
break;case"plaats":_ip.setText(layout.plaats_text,label);reset_game.form.plaats=id;{}
break;case"category":_ip.setText(layout.category_text,label);reset_game.form.category=id;{}
break;}
_ip._fa(layout.popup);_ip._ey();}else
{}}}
function reset_game_storeStuff()
{{}
_ip._eg(layout.feedback_text,false);reset_game.form.wachtwoord=_ip.getText(layout.wachtwoord_text);var error="";if(reset_game.form.plaats=="undefined"||reset_game.form.plaats==-1)
{error="Vul een plaats in!";}
...
{}
{}
_ip._em("user_school",reset_game.form.school);_ip._em("user_groep",reset_game.form.groep);_ip._em("user_plaats",reset_game.form.plaats);if(error=="")
{var data={};data.naam=user.data.naam;data.wachtwoord=reset_game.form.wachtwoord;data.school=reset_game.form.school;data.groep=reset_game.form.groep;data.plaats=reset_game.form.plaats;data.category=reset_game.form.category;console.log(JSON.stringify(data));_ip.getVars("reset_game.php",data,reset_game_ServerCallback,reset_game_ServerFail)}else
{_ip.setText(layout.feedback_text,error);_ip._fd("wrong");_ip._eg(layout.feedback_text,true);{}}}
function reset_game_ServerCallback(response)
{var all;if(response.succes=="1")
{_ip._fd("right");var data={};data.succes=1;data.stat="reset_game";data.user=response.user.naam;_ip.setVars("add_stat.php",data);user.data=response.user;quiz.nr_of_questions=quiz.questions.length;quiz.question_order=response.user.question_order;for(var i=0;i<quiz.question_order.length;i++)
{if(quiz.question_order[i]>=quiz.questions.length)
{quiz.question_order[i]=quiz.questions.length-1;}}
for(all in response)
{{}}
...
{{}}
{}
_ip._em("user_wachtwoord",user.data.wachtwoord);_ip._em("user_naam",response.user.naam);{}
switch(parseInt(response.user.plaats))
{case 1:_ip._gj['houses1']={src:"getCMSImage.php?id=houses&img=steenbergen",w:4904,h:2048,preload:false};break;case 2:_ip._gj['houses2']={src:"getCMSImage.php?id=houses&img=deheen",w:4400,h:2052,preload:false};break;case 2:_ip._gj['houses3']={src:"getCMSImage.php?id=houses&img=nieuwvossemeer",w:3200,h:2048,preload:false};break;case 2:_ip._gj['houses4']={src:"getCMSImage.php?id=houses&img=kruisland",w:2672,h:1708,preload:false};break;case 2:_ip._gj['houses5']={src:"getCMSImage.php?id=houses&img=dinteloord",w:3665,h:2868,preload:false};break;case 2:_ip._gj['houses6']={src:"getCMSImage.php?id=houses&img=welberg",w:2461,h:1231,preload:false};break;}
quiz.init();}else
{var data={};data.succes=0;data.stat="reset_game";_ip.setVars("add_stat.php",data);_ip.setText(layout.feedback_text,"Mislukt: "+response.error);_ip._eg(layout.feedback_text,true);_ip._fd("wrong");{}}}
function reset_game_ServerFail(response)
{var data={};data.succes=0;data.stat="reset_game";_ip.setVars("add_stat.php",data);_ip.setText(layout.feedback_text,"Server bezet, probeer later");_ip._eg(layout.feedback_text,true);_ip._fd("wrong");{}}
function reset_gameHandleButtons(label)
{switch(label)
{case"button_continue_reset_game":reset_game_storeStuff();break;case"button_dropdown_school":reset_game_createPopupList("school");break;case"button_dropdown_groep":reset_game_createPopupList("groep");break;case"button_dropdown_plaats":reset_game_createPopupList("plaats");break;case"button_dropdown_category":reset_game_createPopupList("category");break;case"button_close_popup":_ip._fa(layout.popup);_ip._ey();break;default:{}}}
...
var nr=parseInt(user.data.progress);console.log(user.data.progress+" of "+quiz.question_order);if(nr>=quiz.questions.length)nr=quiz.questions.length-1;var q=quiz.questions[quiz.question_order[parseInt(user.data.progress)]];if(typeof(q)==="undefined")
...
user.data.progress=response["progress"];user.data.old_punten=user.data.punten;user.data.punten=response["punten"];user.data.stenen=response["stenen"];user.data.hints=response["hints"];_ip._eg(layout.popup,true);}}
...
str+=q.right;_ip._hc(layout.popup_window,x,y,w,h,fonts.body,palet.body,"left",fontsz.body,str);w=_ip._gj['buttons'].ss['play'][0][2];h=_ip._gj['buttons'].ss['play'][0][3];x=985/2-w/2;y=928;_ip._hd(layout.popup_window,x,y,w,h,'buttons',"play","button_wrong_continue",_kn);w=_ip._gj['buttons'].ss['speak'][0][2];h=_ip._gj['buttons'].ss['speak'][0][3];_ip._hd(layout.popup_window,985-w,0,w,h,'buttons',"speak","button_speak_right",_kn);}
...
{var i;var new_house_available=-1;var new_score=user.data.punten+100;{}
for(i=0;i<map.shop.length;i++)
{console.log(new_score+" punten, quick check of the shop: "+map.shop[i].naam+","+map.shop[i].unlock+","+map.shop[i].unlocked);if(map.shop[i].unlock<=new_score&&map.shop[i].unlocked==false)
{map.shop[i].unlocked=true;{}
var j=0;var placed=false;if(placed==false)
{new_house_available=i;}}else
{}}
...
w=_ip._gj['buttons'].ss['play'][0][2];h=_ip._gj['buttons'].ss['play'][0][3];x=985/2-w/2;_ip._hd(layout.popup_window,x,y,w,h,'buttons',"continue","button_hint_continue",_kn);w=_ip._gj['buttons'].ss['speak'][0][2];h=_ip._gj['buttons'].ss['speak'][0][3];x=985-w;_ip._hd(layout.popup_window,x,0,w,h,'buttons',"speak","button_speak_hint",_kn);w=985;h=y+280;y=_ip.height/2-h/2;x=_ip.width/2-w/2;_ip._ef(layout.popup_window,w,h);_ip._fj(layout.popup_window,x,y);_ip._eg(layout.popup,false);}
function _ki(nr)
{if(nr>=quiz.questions.length)nr=quiz.questions.length-1;var q=quiz.questions[nr];if(typeof(q)=="undefined")
...
var i;q.hussle_antwoorden=hussle_antwoorden;for(i=0;i<4;i++)
...
var q=quiz.questions[quiz.question_order[parseInt(user.data.progress)]];var answer_codes=["A","B","C","D"];switch(label)
{case"button_speak_question":_ip.playVoice("question_"+q.id+"_body.mp3");break;case"button_speak_right":q=quiz.questions[quiz.question_order[parseInt(user.data.progress)-1]];_ip.playVoice("question_"+q.id+"_right.mp3");break;case"button_speak_hint":_ip.playVoice("question_"+q.id+"_hint.mp3");break;case"button_speak_answer_0":_ip.playVoice("question_"+q.id+"_"+answer_codes[q.hussle_antwoorden[0]]+".mp3");break;case"button_speak_answer_1":_ip.playVoice("question_"+q.id+"_"+answer_codes[q.hussle_antwoorden[1]]+".mp3");break;case"button_speak_answer_2":_ip.playVoice("question_"+q.id+"_"+answer_codes[q.hussle_antwoorden[2]]+".mp3");break;case"button_speak_answer_3":_ip.playVoice("question_"+q.id+"_"+answer_codes[q.hussle_antwoorden[3]]+".mp3");break;case"button_place_on_map":map.init();break;case"button_right_continue":case"button_wrong_continue":var nr=parseInt(user.data.progress);if(nr>=quiz.question_order.length)
...
break;case"button_again":reset_game.init();if(0)
...
map.houses=[];var i=0;for(i=0;i<user.data.bought_per_city[map.current_map].length;i++){{}
...
console.log("map.current_map: "+map.current_map);console.log("user houses in this city: "+JSON.stringify(map.houses));map.houses.sort(_ko);_jbmap();if(1)
_kp();else{{}
map.state="displaying";_jbmap();map_UpdateScrollbar();}}
function _ko(a,b){if(a.ly>b.ly)return 1;if(a.ly<b.ly)return-1;return 0;}
function _kp(){var data={};map.state="loading";data.city=map.current_map;{}
_ip.getVars("get_map_images_per_city.php?ck="+(new Date).getTime(),data,_kq,_ks);}
function _kq(response){{}
var id;var default_houses_need_to_be_placed="";if(response.succes=="1"){{}
for(id in response.images){{}
var im=response.images[id];for(var b in im){if(b!="src")
{}}
var o={};o.src=im.src;o.id=id;o.naam=im.naam;o.w=parseInt(im.w);o.h=parseInt(im.h);o.rx=parseInt(im.rx);o.ry=parseInt(im.ry);if(o.rx>o.w||o.rx<o.w)o.rx=o.w/2;if(o.ry>o.h||o.ry<o.h)o.ry=o.h;o.lx=parseInt(im.lx);o.ly=parseInt(im.ly);o.preload=true;o.kind="sprite";o.ss={};o.ss.house=[[0,0,o.w,o.h,0,o.rx,o.ry]];_ip.addToManifest(o,id,"dataURL",_kr);if(parseInt(im.city)==7){var i;var in_shop=false;for(i=0;i<map.shop.length;i++){{}
if(map.shop[i].img==id)in_shop=true;}
if(in_shop==false){{}
var o={};o.naam=im.naam;o.prijs=parseInt(im.prijs);o.unlock=parseInt(im.unlock);o.unlocked=false;if(user.data.punten>=o.unlock){o.unlocked=true;}
o.img=id;map.shop.push(o);}}else{if(o.lx==0&&o.ly==0){{}
...
{}
map.shop.sort(byUnlock);map.houses.sort(_ko);if(default_houses_need_to_be_placed!=""){_ip.showWarning("Some default houses need to be placed:\n"+default_houses_need_to_be_placed+"\nYou can find these in the shop until you place them.");}}else{var all;for(all in response)
{}}
if(layout.ismap==true){_kt();}}
function byUnlock(a,b){if(a.unlock>b.unlock)return 1;if(a.unlock<b.unlock)return-1;return 0;}
function _kr(){if(layout.ismap==true){{}
if(_ip.checkAllImagesLoaded()==true){{}
map.state="displaying";_kt();_jbmap();map_UpdateScrollbar();}}else{if(_ip.checkAllImagesLoaded()==true){{}}else{{}}}}
function _ks(response){{}}
function mapLoop(){var refreshMenu=false;if(Math.abs(map.menu_speed)>1){map.menu_offset-=map.menu_speed;map.menu_speed*=0.9;refreshMenu=true;}
if(map.menu_offset<0){map.menu_offset*=0.9;map.menu_speed=0;refreshMenu=true;}
if(map.menu_offset>(map.menu_height-layout.menu_viewport)){map.menu_offset=(map.menu_height-layout.menu_viewport)*0.1+0.9*map.menu_offset;map.menu_speed=0;refreshMenu=true;}
if(refreshMenu){_ip._fj(layout.menu_inside,0,-map.menu_offset);}
var refreshMap=false;if(map.just_changed){refreshMap=true;map.just_changed=false;}
if(Math.abs(map.offset.dx)>1||Math.abs(map.offset.dy)>1){map.offset.x-=map.offset.dx;map.offset.y-=map.offset.dy;map.offset.dx*=0.9;map.offset.dy*=0.9;refreshMap=true;}
if(map.offset.x<0){map.offset.x*=0.9;map.offset.dx=0;refreshMap=true;}
if(map.offset.x>(map.back_w-layout.map.w)){map.offset.x=0.9*map.offset.x+0.1*(map.back_w-layout.map.w);map.offset.dx=0;refreshMap=true;}
if(map.offset.y<0){map.offset.y*=0.9;map.offset.dy=0;refreshMap=true;}
if(map.offset.y>(map.back_h-layout.map.h)){map.offset.y=0.9*map.offset.y+0.1*(map.back_h-layout.map.h);map.offset.dy=0;refreshMap=true;}
switch(map.state){case"loading":refreshMap=false;break;}
if(refreshMap){_ip._fj(layout.map_inside,-map.offset.x,-map.offset.y);_kt();map_drawScrollbar();}}
function _kt(){var i;if(typeof(layout.map_canvas.context)==="undefined"){{}
return;}
var ctx=layout.map_canvas.context;_ip._hk(layout.map_canvas);for(i=0;i<map.houses.length;i++){if(map.houses[i].id=="house"){ctx.fillStyle="#f00";ctx.fillRect(map.houses[i].lx-map.offset.x-10,map.houses[i].ly-map.offset.y-10,20,20);}else{if(typeof(map.houses[i])!=="undefined"){_ip._gr(layout.map_canvas,map.houses[i].id,"house",map.houses[i].lx-map.offset.x,map.houses[i].ly-map.offset.y,0,0,1);}else{{}}}}}
function _jbmap(){var pass_test=false;if(typeof(layout.last_resize)==="undefined"){pass_test=true;}else{var dt=layout.last_resize-(new Date()).getTime();if(dt>100){pass_test=true;}}
if(pass_test==false){{}
return;}else{layout.last_resize=(new Date()).getTime();}
{}
_ip._gp();layout={};layout.ismap=true;layout.back=_ip._he();_ip._es(layout.back,palet.pale_green);var w,h,x,y,f,tx,ty,string;w=_ip.width;h=map.bar_height;x=0;y=0;layout.bar=_ip._hi(layout.back,x,y,w,h);_ip._es(layout.bar,palet.pale_blue);var city=map.plaats[map.current_map];layout.city_name=_ip._hc(layout.bar,100,20,550,100,fonts.head,"#fff","left",fontsz.head,city);w=412;h=30;x=(_ip.width-1000);y=(quiz.bar_height-h)/2+5;{}
...
function _kv(nr){var w=map.menu_width,h=map.button_height;_ip._hk(map.shop[nr].canv);var ctx=map.shop[nr].canv.context;ctx.font=fontsz.menu+'px '+fonts.head;ctx.textAlign='left';ctx.fillStyle="#fff";ctx.fillText((nr+1)+") "+map.shop[nr].naam,34,400);ctx.font=fontsz.body+'px '+fonts.body;ctx.textAlign='right';ctx.fillStyle="#fff";ctx.fillText(map.shop[nr].prijs+" stenen",494,400);ctx.fillStyle="#fff";ctx.fillRect(35,35,map.menu_width-70,320);var fx=(map.menu_width-70)/_ip._gj[map.shop[nr].img].w;var fy=320/_ip._gj[map.shop[nr].img].h;var f=fx;if(fy<fx)f=fy;if(f>0.9&&f<1.1)f=1;else f*=0.9;_ip.drawImage(map.shop[nr].canv,map.shop[nr].img,35+(map.menu_width-70)/2,35+320/2,0,f);console.log(map.shop[nr].unlock+">"+parseInt(user.data.punten))
if(map.shop[nr].unlock>parseInt(user.data.punten)){ctx.save();ctx.globalCompositeOperation="xor";_ip.drawImage(map.shop[nr].canv,map.shop[nr].img,35+(w-70)/2,35+320/2,0,f);ctx.restore();ctx.fillStyle="rgba(87,118,135,0.9)";ctx.fillRect(0,35,map.menu_width,330);ctx.strokeStyle="#fff";ctx.lineWidth=2;ctx.strokeRect(35,35,w-70,320);ctx.strokeRect(35,h-92,w-70,20);ctx.fillStyle="#fff";ctx.font=fontsz.head+'px '+fonts.head;ctx.textAlign='center';var pct=user.data.punten/map.shop[nr].unlock;ctx.fillRect(37,h-90,(w-74)*pct,16);ctx.fillText("beschikbaar bij",w/2,h/2-40);ctx.fillText(map.shop[nr].unlock+" punten",w/2,h/2);}else{if(map.shop[nr].prijs>parseInt(user.data.stenen)){ctx.fillStyle="rgba(87,118,135,0.5)";ctx.fillRect(0,35,map.menu_width,420);ctx.fillStyle="#fff";ctx.font=fontsz.head+'px '+fonts.head;ctx.textAlign='center';ctx.fillText("Stenen nodig: "+(map.shop[nr].prijs-user.data.stenen),w/2,h/2);}}
ctx.fillStyle="#fff";ctx.fillRect(35,map.button_height-3,map.menu_width-70,3);_ip.mouseWheelCallback=map_HandleMousewheel;}
function map_drawScrollbar(){var i;_ip._hk(layout.scroll_canvas);var ctx=layout.scroll_canvas.context;ctx.fillStyle="rgba(255,255,255,0.6)";ctx.fillRect(0,0,layout.scroll.back.w,layout.scroll.back.h);ctx.fillStyle="rgba(255,255,255,0.6)";ctx.fillRect(layout.scroll.track.x,layout.scroll.track.y,layout.scroll.track.w,layout.scroll.track.h);ctx.fillStyle=palet.pale_blue;ctx.fillRect(layout.scroll.track.x,layout.scroll.track.y+layout.scroll.y,layout.scroll.track.w,layout.scroll.size);ctx.beginPath();ctx.moveTo(10,35);ctx.lineTo(25,12);ctx.lineTo(40,35);ctx.closePath();ctx.fill();ctx.beginPath();ctx.moveTo(10,layout.scroll.back.h-35);ctx.lineTo(25,layout.scroll.back.h-12);ctx.lineTo(40,layout.scroll.back.h-35);ctx.closePath();ctx.fill();}
function map_HandleMousewheel(d){layout.scroll.y-=d;map_userControlledScrollbar();}
...
function map_clampScrollbar(){if(layout.scroll.y<0)layout.scroll.y=0;if(layout.scroll.y>(layout.scroll.track.h-layout.scroll.size))layout.scroll.y=(layout.scroll.track.h-layout.scroll.size);}
function map_userControlledScrollbar(){map_clampScrollbar();map_drawScrollbar();map.menu_offset=(map.menu_height-layout.menu_viewport)*layout.scroll.y/(layout.scroll.track.h-layout.scroll.size);map.menu_speed=1.1;}
function map_HandleDown(id,x,y){console.log("map_HandleDown");if(y>map.bar_height){if(x<map.menu_width){map.menudragdir="";{}
map.down={x:x,y:y};map.button_clicked=Math.floor((y-map.bar_height+map.menu_offset)/map.button_height);map.dragTarget="menu";{}
var cost=_ky(map.shop[map.button_clicked].img);var unlocked=getUnlockFromId(map.shop[map.button_clicked].img);{}
{}
{}
if(cost>user.data.stenen){map.button_clicked=-1;{}}
if(unlocked>user.data.punten){map.button_clicked=-1;{}}}else{if(x<(layout.scroll.back.x+layout.scroll.back.w)){map.down={x:x,y:y};x=x-layout.scroll.back.x;y=y-layout.scroll.back.y;{}
var handled=false;if(handled==false&&y<layout.scroll.track.y){handled=true;{}
layout.scroll.y-=10;map_userControlledScrollbar();map.dragging=-1;}
if(handled==false&&y>(layout.scroll.back.h-layout.scroll.track.y)){handled=true;{}
layout.scroll.y+=10;map_userControlledScrollbar();map.dragging=-1;}
y=y-layout.scroll.track.y;if(handled==false&&y<(layout.scroll.y)){handled=true;{}
map.dragging=-1;layout.scroll.y-=120;map_userControlledScrollbar();}
if(handled==false&&y>(layout.scroll.y+layout.scroll.size)){handled=true;{}
map.dragging=-1;layout.scroll.y+=120;map_userControlledScrollbar();}
if(handled==false&&y>=(layout.scroll.y)&&y<=(layout.scroll.y+layout.scroll.size)){handled=true;{}
map.dragging=1;layout.scroll.down={x:x,y:y-layout.scroll.y};map.dragTarget="scroll";}}else{var hit_house=-1;var min_dist=10000000;var max_y=-10000000;{}
for(i=0;i<map.houses.length;i++){if(map.houses[i].id!="house"){{}
if(map.houses[i].moveable){var im=map.houses[i].id;var kader={};kader.x=Math.floor(map.houses[i].lx-map.offset.x-_ip._gj[im].rx);kader.y=Math.floor(map.houses[i].ly-map.offset.y-_ip._gj[im].ry);kader.w=_ip._gj[im].w;kader.h=_ip._gj[im].h;{}
if((x-map.menu_width)>kader.x&&(x-map.menu_width)<(kader.x+kader.w)&&(y-map.bar_height)>kader.y&&(y-map.bar_height)<(kader.y+kader.h)){var dx=(map.houses[i].lx-map.offset.x)-(x-map.menu_width);var dy=(map.houses[i].ly-map.offset.y)-(y-map.bar_height);var len=Math.sqrt(dx*dx+dy*dy);if(max_y<map.houses[i].ly&&len<min_dist){max_y=map.houses[i].ly;min_dist=len;hit_house=i;}}}}else{{}}}
...
{}
{}
var data={};data.id=map.drag_object.id.split("_")[1];data.lx=Math.floor(map_x);data.ly=Math.floor(map_y);_ip.getVars("set_default_pos.php",data,_lb,_lc);}else{var data={};data.id=map.drag_object.id.split("_")[1];data.lx=Math.floor(map_x);data.ly=Math.floor(map_y);data.prijs=_ky(map.drag_object.id);data.naam=_ip._gn("user_naam");data.map=map.current_map;data.wachtwoord=_ip._gn("user_wachtwoord");{}
_ip.getVars("buy_house.php",data,_kz,_la);user.data.bought_per_city[map.current_map].push({id:data.id,lx:data.lx,ly:data.ly});user.data.stenen-=parseInt(data.prijs);_ip.setText(layout.score_label,"Score <em>"+parseInt(user.data.punten)+"</em> punten / <em>"+parseInt(user.data.stenen)+"</em> stenen");var i;for(i=0;i<map.shop.length;i++){_kv(i);}
...
{var id;if(parseInt(response.succes)==1){{}}else{{}}}
function _la(response){{}}
function _lb(response){var id;if(parseInt(response.succes)==1){{}}else{{}}}
function _lc(response){{}}
function _ld(id,x,y,dx,dy){console.log("_ld "+map.dragTarget);switch(map.dragTarget){case"scroll":if(map.dragging!=-1){x=x-layout.scroll.back.x;y=y-layout.scroll.back.y;y=y-layout.scroll.track.y;layout.scroll.y=(y-layout.scroll.down.y);map_userControlledScrollbar();}
break;case"moveHouse":if(map.dragging!=-1){_ip._fj(layout.dragitem,x+map.drag_object.gx,y+map.drag_object.gy);}
break;case"menu":if(map.dragging!=-1){_ip._fj(layout.dragitem,x+map.drag_object.gx,y+map.drag_object.gy);{}}else{var swipe_dx=map.down.x-x;var swipe_dy=map.down.y-y;var swipe_len=Math.sqrt(swipe_dx*swipe_dx+swipe_dy*swipe_dy);if(swipe_len>10||map.menudragdir!="")
{if(map.menudragdir==""){var swipe_dx=map.down.x-x;var swipe_dy=map.down.y-y;if(Math.abs(dx)>Math.abs(dy)){map.menudragdir="hori";}else{map.menudragdir="verti";}
if(map.button_clicked==-1)
map.menudragdir="verti";}
{}
if(map.menudragdir=="verti"){map.menu_speed=dy;map_UpdateScrollbar();}else{{}
...
function _le(label){switch(label){case"button_play":_ip.stopLoop();wwjw.page_extras="";quiz.init();break;case"button_stop":_ip.stopLoop();start.init();break;case"button_continue":_ip.stopLoop();var nr=parseInt(user.data.progress);quiz.init();break;case"button_high":_ip.stopLoop();high.init();break;case"button_prev":map.dragging=-1;map.dragTarget="none";map.current_map--;if(map.current_map==0)map.current_map=6;initMap();break;case"button_next":map.dragging=-1;map.dragTarget="none";map.current_map++;if(map.current_map==7)map.current_map=1;initMap();break;default:{}}}
...
function _lq(nr)
{{}
high.selected_tab=nr;var i;for(i=0;i<high.tabs.length;i++)
...
{{}
high.selected_period=nr;var i;for(i=0;i<high.periods.length;i++)
