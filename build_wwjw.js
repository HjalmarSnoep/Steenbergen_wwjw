        ...
        "hous_fOC1afuLwj": {
            ...
            "kind": "sprite"
				...
				*/
				...
				o.kind="sprite";
				o.ss={};
				o.ss.house=[[0,0,o.w,o.h,0,o.rx,o.ry]];
			...
			}else
			{
				...
				if(x<(layout.scroll.back.x+layout.scroll.back.w))
				{
					...
					if(handled==false && y>=(layout.scroll.y) && y<=(layout.scroll.y+layout.scroll.size))
					{
						...
						layout.scroll.down={x:x,y:y-layout.scroll.y};
		...
		switch(map.dragTarget)
		{
			...
			case "moveHouse":
				...
				if(map.dragging!=-1)
				{
					...
					map.houses.push({id:map.drag_object.id,lx:map_x,ly:map_y,moveable:true}); // you dropped it, you can move it
